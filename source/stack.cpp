...
stackErrorField stackCtor(stack *stk, size_t capacity)
{
    ...
    stk->data = (stack_elem_t *)myCalloc(stk->capacity, sizeof(stack_elem_t));
    ...
    CANARY_PROTECTION (
        *(unsigned long long *) stk->data                  = BUF_CANARY;
        stk->data = (stack_elem_t *)((unsigned long long *)stk->data + 1);
...
stackErrorField stackRealloc(stack *stk)
{
    ...
    CANARY_PROTECTION (
        stk->data = (stack_elem_t *)((long long *)stk->data - 1);
    ...
    if (stk->size >= stk->capacity)
    {
        ...
        stk->data = (stack_elem_t *)realloc(stk->data, stk->capacity * sizeof(stack_elem_t) + 2 * sizeof(long long));
    }
...
unsigned int stackHashCalc(stack *stk)
{
    ...
    size_t bufSize = stk->capacity * sizeof(stack_elem_t);
